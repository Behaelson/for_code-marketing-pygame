...
class SnakeGame:
    def __init__(self):
        pygame.init()
        self.imagem_titulo = pygame.image.load('C:/Users/Behael/Desktop/Projeto/trabalhos/Trabalhos/mkt-for_snake/for_code-marketing-pygame/jogo_antigo/titulo.png')
